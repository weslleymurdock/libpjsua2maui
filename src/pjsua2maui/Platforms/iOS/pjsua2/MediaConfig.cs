...
public class MediaConfig : PersistentObject {
  ...
  public SWIGTYPE_p_pjmedia_jb_discard_algo jbDiscardAlgo {
    set {
      pjsua2PINVOKE.MediaConfig_jbDiscardAlgo_set(swigCPtr, SWIGTYPE_p_pjmedia_jb_discard_algo.getCPtr(value));
      if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      SWIGTYPE_p_pjmedia_jb_discard_algo ret = new SWIGTYPE_p_pjmedia_jb_discard_algo(pjsua2PINVOKE.MediaConfig_jbDiscardAlgo_get(swigCPtr), true);
      if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
