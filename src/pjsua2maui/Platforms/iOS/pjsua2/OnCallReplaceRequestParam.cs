...
public class OnCallReplaceRequestParam : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(OnCallReplaceRequestParam obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public Call newCall {
    set {
      pjsua2PINVOKE.OnCallReplaceRequestParam_newCall_set(swigCPtr, Call.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = pjsua2PINVOKE.OnCallReplaceRequestParam_newCall_get(swigCPtr);
