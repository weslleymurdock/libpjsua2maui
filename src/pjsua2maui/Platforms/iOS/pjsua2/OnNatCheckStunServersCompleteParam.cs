...
public class OnNatCheckStunServersCompleteParam : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(OnNatCheckStunServersCompleteParam obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public System.IntPtr userData {
    set {
      pjsua2PINVOKE.OnNatCheckStunServersCompleteParam_userData_set(swigCPtr, value);
    } 
    get {
        System.IntPtr cPtr = pjsua2PINVOKE.OnNatCheckStunServersCompleteParam_userData_get(swigCPtr);
        return cPtr;
    }
