...
public class VideoDevInfo : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(VideoDevInfo obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public MediaFormatVideoVector fmt {
    set {
      pjsua2PINVOKE.VideoDevInfo_fmt_set(swigCPtr, MediaFormatVideoVector.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = pjsua2PINVOKE.VideoDevInfo_fmt_get(swigCPtr);
      MediaFormatVideoVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new MediaFormatVideoVector(cPtr, false);
      return ret;
    } 
  }
