...
public class OnCallReplacedParam : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(OnCallReplacedParam obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public Call newCall {
    set {
      pjsua2PINVOKE.OnCallReplacedParam_newCall_set(swigCPtr, Call.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = pjsua2PINVOKE.OnCallReplacedParam_newCall_get(swigCPtr);
