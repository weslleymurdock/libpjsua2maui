...
public class VideoWindow : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(VideoWindow obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void setFullScreen(bool enabled) {
    pjsua2PINVOKE.VideoWindow_setFullScreen(swigCPtr, enabled);
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }

  public void setFullScreen2(pjmedia_vid_dev_fullscreen_flag mode) {
    pjsua2PINVOKE.VideoWindow_setFullScreen2(swigCPtr, (int)mode);
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }
