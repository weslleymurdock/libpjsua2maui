...
public class SipTransaction : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(SipTransaction obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public System.IntPtr pjTransaction {
    set {
      pjsua2PINVOKE.SipTransaction_pjTransaction_set(swigCPtr, value);
    } 
    get {
        System.IntPtr cPtr = pjsua2PINVOKE.SipTransaction_pjTransaction_get(swigCPtr);
        return cPtr;
    }
