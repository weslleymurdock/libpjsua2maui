...
public class VidDevManager : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(VidDevManager obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void initSubsys() {
    pjsua2PINVOKE.VidDevManager_initSubsys(swigCPtr);
