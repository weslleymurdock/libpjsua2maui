...
public class AccountIpChangeConfig : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(AccountIpChangeConfig obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public uint reinvUseUpdate {
    set {
      pjsua2PINVOKE.AccountIpChangeConfig_reinvUseUpdate_set(swigCPtr, value);
    } 
    get {
      uint ret = pjsua2PINVOKE.AccountIpChangeConfig_reinvUseUpdate_get(swigCPtr);
      return ret;
    } 
  }
