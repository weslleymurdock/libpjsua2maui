...
public class AudioMediaPlayer : AudioMedia {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(AudioMediaPlayer obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private bool SwigDerivedClassHasMethod(string methodName, global::System.Type[] methodTypes) {
    ...
    foreach (global::System.Reflection.MethodInfo methodInfo in methodInfos) {
      ...
      if (methodInfo.IsVirtual && (methodInfo.DeclaringType.IsSubclassOf(typeof(AudioMediaPlayer))) &&
