...
public class AccountNatConfig : PersistentObject {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(AccountNatConfig obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public pjsua_upnp_use sipUpnpUse {
    set {
      pjsua2PINVOKE.AccountNatConfig_sipUpnpUse_set(swigCPtr, (int)value);
    } 
    get {
      pjsua_upnp_use ret = (pjsua_upnp_use)pjsua2PINVOKE.AccountNatConfig_sipUpnpUse_get(swigCPtr);
      return ret;
    } 
  }

  public pjsua_upnp_use mediaUpnpUse {
    set {
      pjsua2PINVOKE.AccountNatConfig_mediaUpnpUse_set(swigCPtr, (int)value);
    } 
    get {
      pjsua_upnp_use ret = (pjsua_upnp_use)pjsua2PINVOKE.AccountNatConfig_mediaUpnpUse_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public pj_ice_sess_trickle iceTrickle {
    set {
      pjsua2PINVOKE.AccountNatConfig_iceTrickle_set(swigCPtr, (int)value);
    } 
    get {
      pj_ice_sess_trickle ret = (pj_ice_sess_trickle)pjsua2PINVOKE.AccountNatConfig_iceTrickle_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public StringVector iceManualHost {
    set {
      pjsua2PINVOKE.AccountNatConfig_iceManualHost_set(swigCPtr, StringVector.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = pjsua2PINVOKE.AccountNatConfig_iceManualHost_get(swigCPtr);
  ...
  public uint iceCheckSrcAddr {
    set {
      pjsua2PINVOKE.AccountNatConfig_iceCheckSrcAddr_set(swigCPtr, value);
    } 
    get {
      uint ret = pjsua2PINVOKE.AccountNatConfig_iceCheckSrcAddr_get(swigCPtr);
      return ret;
    } 
  }
