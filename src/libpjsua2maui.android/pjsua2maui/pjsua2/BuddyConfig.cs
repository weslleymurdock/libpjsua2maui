...
public class BuddyConfig : PersistentObject {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(BuddyConfig obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public bool subscribe_dlg_event {
    set {
      pjsua2PINVOKE.BuddyConfig_subscribe_dlg_event_set(swigCPtr, value);
    } 
    get {
      bool ret = pjsua2PINVOKE.BuddyConfig_subscribe_dlg_event_get(swigCPtr);
      return ret;
    } 
  }
