...
public class AccountSipConfig : PersistentObject {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(AccountSipConfig obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public bool autoRespondSipMessage {
    set {
      pjsua2PINVOKE.AccountSipConfig_autoRespondSipMessage_set(swigCPtr, value);
    } 
    get {
      bool ret = pjsua2PINVOKE.AccountSipConfig_autoRespondSipMessage_get(swigCPtr);
      return ret;
    } 
  }
