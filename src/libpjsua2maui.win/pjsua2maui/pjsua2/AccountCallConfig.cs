...
public class AccountCallConfig : PersistentObject {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(AccountCallConfig obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public pjsua_sip_siprec_use siprecUse {
    set {
      pjsua2PINVOKE.AccountCallConfig_siprecUse_set(swigCPtr, (int)value);
    } 
    get {
      pjsua_sip_siprec_use ret = (pjsua_sip_siprec_use)pjsua2PINVOKE.AccountCallConfig_siprecUse_get(swigCPtr);
      return ret;
    } 
  }
