...
public class AccountRegConfig : PersistentObject {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(AccountRegConfig obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public bool disableRegOnModify {
    set {
      pjsua2PINVOKE.AccountRegConfig_disableRegOnModify_set(swigCPtr, value);
    } 
    get {
      bool ret = pjsua2PINVOKE.AccountRegConfig_disableRegOnModify_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public string contactUriParams {
    set {
      pjsua2PINVOKE.AccountRegConfig_contactUriParams_set(swigCPtr, value);
      if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      string ret = pjsua2PINVOKE.AccountRegConfig_contactUriParams_get(swigCPtr);
      if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
