...
public class Account : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(Account obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void shutdown2(AccountShutdownParam prm) {
    pjsua2PINVOKE.Account_shutdown2(swigCPtr, AccountShutdownParam.getCPtr(prm));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void sendRequest(SendRequestParam prm) {
    pjsua2PINVOKE.Account_sendRequest(swigCPtr, SendRequestParam.getCPtr(prm));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }

  public void sendResponse(SendResponseParam prm) {
    pjsua2PINVOKE.Account_sendResponse(swigCPtr, SendResponseParam.getCPtr(prm));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public virtual void onSendRequest(OnSendRequestParam prm) {
    if (SwigDerivedClassHasMethod("onSendRequest", swigMethodTypes6)) pjsua2PINVOKE.Account_onSendRequestSwigExplicitAccount(swigCPtr, OnSendRequestParam.getCPtr(prm)); else pjsua2PINVOKE.Account_onSendRequest(swigCPtr, OnSendRequestParam.getCPtr(prm));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void onTypingIndication(OnTypingIndicationParam prm) {
    if (SwigDerivedClassHasMethod("onTypingIndication", swigMethodTypes7)) pjsua2PINVOKE.Account_onTypingIndicationSwigExplicitAccount(swigCPtr, OnTypingIndicationParam.getCPtr(prm)); else pjsua2PINVOKE.Account_onTypingIndication(swigCPtr, OnTypingIndicationParam.getCPtr(prm));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void onMwiInfo(OnMwiInfoParam prm) {
    if (SwigDerivedClassHasMethod("onMwiInfo", swigMethodTypes8)) pjsua2PINVOKE.Account_onMwiInfoSwigExplicitAccount(swigCPtr, OnMwiInfoParam.getCPtr(prm)); else pjsua2PINVOKE.Account_onMwiInfo(swigCPtr, OnMwiInfoParam.getCPtr(prm));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual void onAuthChallenge(OnAuthChallengeParam prm) {
    if (SwigDerivedClassHasMethod("onAuthChallenge", swigMethodTypes9)) pjsua2PINVOKE.Account_onAuthChallengeSwigExplicitAccount(swigCPtr, OnAuthChallengeParam.getCPtr(prm)); else pjsua2PINVOKE.Account_onAuthChallenge(swigCPtr, OnAuthChallengeParam.getCPtr(prm));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    if (SwigDerivedClassHasMethod("onSendRequest", swigMethodTypes6))
      swigDelegate6 = new SwigDelegateAccount_6(SwigDirectorMethodonSendRequest);
    if (SwigDerivedClassHasMethod("onTypingIndication", swigMethodTypes7))
      swigDelegate7 = new SwigDelegateAccount_7(SwigDirectorMethodonTypingIndication);
    if (SwigDerivedClassHasMethod("onMwiInfo", swigMethodTypes8))
      swigDelegate8 = new SwigDelegateAccount_8(SwigDirectorMethodonMwiInfo);
    if (SwigDerivedClassHasMethod("onAuthChallenge", swigMethodTypes9))
      swigDelegate9 = new SwigDelegateAccount_9(SwigDirectorMethodonAuthChallenge);
    pjsua2PINVOKE.Account_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8, swigDelegate9);
  }
  ...
  private bool SwigDerivedClassHasMethod(string methodName, global::System.Type[] methodTypes) {
    ...
    foreach (global::System.Reflection.MethodInfo methodInfo in methodInfos) {
      ...
      if (methodInfo.IsVirtual && (methodInfo.DeclaringType.IsSubclassOf(typeof(Account))) &&
  ...
  private void SwigDirectorMethodonSendRequest(global::System.IntPtr prm) {
    onSendRequest(new OnSendRequestParam(prm, false));
  }
  ...
  private void SwigDirectorMethodonAuthChallenge(global::System.IntPtr prm) {
    onAuthChallenge(new OnAuthChallengeParam(prm, false));
  }
  ...
  public delegate void SwigDelegateAccount_8(global::System.IntPtr prm);
  public delegate void SwigDelegateAccount_9(global::System.IntPtr prm);
  ...
  private SwigDelegateAccount_8 swigDelegate8;
  private SwigDelegateAccount_9 swigDelegate9;
  ...
  private static global::System.Type[] swigMethodTypes6 = new global::System.Type[] { typeof(OnSendRequestParam) };
  private static global::System.Type[] swigMethodTypes7 = new global::System.Type[] { typeof(OnTypingIndicationParam) };
  private static global::System.Type[] swigMethodTypes8 = new global::System.Type[] { typeof(OnMwiInfoParam) };
  private static global::System.Type[] swigMethodTypes9 = new global::System.Type[] { typeof(OnAuthChallengeParam) };
}
