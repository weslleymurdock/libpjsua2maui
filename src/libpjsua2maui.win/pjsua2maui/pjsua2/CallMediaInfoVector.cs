...
public class CallMediaInfoVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<CallMediaInfo>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(CallMediaInfoVector obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public CallMediaInfoVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public CallMediaInfoVector(global::System.Collections.Generic.IEnumerable<CallMediaInfo> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (CallMediaInfo element in c) {
      this.Add(element);
  ...
  public CallMediaInfo[] ToArray() {
    CallMediaInfo[] array = new CallMediaInfo[this.Count];
    this.CopyTo(array);
    return array;
  }
  ...
  private bool empty() {
    bool ret = pjsua2PINVOKE.CallMediaInfoVector_empty(swigCPtr);
    return ret;
  }
