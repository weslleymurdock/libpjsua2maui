...
public class SipHeaderVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<SipHeader>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(SipHeaderVector obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public SipHeaderVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public SipHeaderVector(global::System.Collections.Generic.IEnumerable<SipHeader> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (SipHeader element in c) {
      this.Add(element);
  ...
  public SipHeader[] ToArray() {
    SipHeader[] array = new SipHeader[this.Count];
    this.CopyTo(array);
    return array;
  }
  ...
  private bool empty() {
    bool ret = pjsua2PINVOKE.SipHeaderVector_empty(swigCPtr);
    return ret;
  }
