...
public enum pjmedia_echo_flag {
  ...
  PJMEDIA_ECHO_AGGRESSIVENESS_CONSERVATIVE = 4096,
  PJMEDIA_ECHO_AGGRESSIVENESS_MODERATE = 8192,
  PJMEDIA_ECHO_AGGRESSIVENESS_AGGRESSIVE = 12288,
  PJMEDIA_ECHO_AGGRESSIVENESS_MASK = 61440
}
