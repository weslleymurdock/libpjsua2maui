...
public class MediaFormatAudio : MediaFormat {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(MediaFormatAudio obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void init(uint formatId, uint clockRate, uint channelCount, int frameTimeUsec, int bitsPerSample, uint avgBps, uint maxBps) {
    pjsua2PINVOKE.MediaFormatAudio_init__SWIG_0(swigCPtr, formatId, clockRate, channelCount, frameTimeUsec, bitsPerSample, avgBps, maxBps);
  }

  public void init(uint formatId, uint clockRate, uint channelCount, int frameTimeUsec, int bitsPerSample, uint avgBps) {
    pjsua2PINVOKE.MediaFormatAudio_init__SWIG_1(swigCPtr, formatId, clockRate, channelCount, frameTimeUsec, bitsPerSample, avgBps);
  }

  public void init(uint formatId, uint clockRate, uint channelCount, int frameTimeUsec, int bitsPerSample) {
    pjsua2PINVOKE.MediaFormatAudio_init__SWIG_2(swigCPtr, formatId, clockRate, channelCount, frameTimeUsec, bitsPerSample);
  }
