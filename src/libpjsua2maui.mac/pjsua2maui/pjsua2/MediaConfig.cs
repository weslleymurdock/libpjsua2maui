...
public class MediaConfig : PersistentObject {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(MediaConfig obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public bool sndUseSwClock {
    set {
      pjsua2PINVOKE.MediaConfig_sndUseSwClock_set(swigCPtr, value);
    } 
    get {
      bool ret = pjsua2PINVOKE.MediaConfig_sndUseSwClock_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public uint confThreads {
    set {
      pjsua2PINVOKE.MediaConfig_confThreads_set(swigCPtr, value);
    } 
    get {
      uint ret = pjsua2PINVOKE.MediaConfig_confThreads_get(swigCPtr);
      return ret;
    } 
  }
  ...
  public pjmedia_jb_discard_algo jbDiscardAlgo {
    set {
      pjsua2PINVOKE.MediaConfig_jbDiscardAlgo_set(swigCPtr, (int)value);
    } 
    get {
      pjmedia_jb_discard_algo ret = (pjmedia_jb_discard_algo)pjsua2PINVOKE.MediaConfig_jbDiscardAlgo_get(swigCPtr);
      return ret;
    } 
  }
