...
public class BuddyInfo : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(BuddyInfo obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public int accId {
    set {
      pjsua2PINVOKE.BuddyInfo_accId_set(swigCPtr, value);
    } 
    get {
      int ret = pjsua2PINVOKE.BuddyInfo_accId_get(swigCPtr);
      return ret;
    } 
  }
