...
public class AccountConfig : PersistentObject {
  ...
  public AccountTextConfig textConfig {
    set {
      pjsua2PINVOKE.AccountConfig_textConfig_set(swigCPtr, AccountTextConfig.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = pjsua2PINVOKE.AccountConfig_textConfig_get(swigCPtr);
      AccountTextConfig ret = (cPtr == global::System.IntPtr.Zero) ? null : new AccountTextConfig(cPtr, false);
      return ret;
    } 
  }
