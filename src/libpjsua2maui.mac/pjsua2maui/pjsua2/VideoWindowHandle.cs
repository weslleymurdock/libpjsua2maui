...
public class VideoWindowHandle : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(VideoWindowHandle obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public pjmedia_vid_dev_hwnd_type type {
    set {
      pjsua2PINVOKE.VideoWindowHandle_type_set(swigCPtr, (int)value);
    } 
    get {
      pjmedia_vid_dev_hwnd_type ret = (pjmedia_vid_dev_hwnd_type)pjsua2PINVOKE.VideoWindowHandle_type_get(swigCPtr);
      return ret;
    } 
  }
