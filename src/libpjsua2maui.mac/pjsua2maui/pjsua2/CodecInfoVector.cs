...
public class CodecInfoVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IList<CodecInfo>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(CodecInfoVector obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public CodecInfoVector(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public CodecInfoVector(global::System.Collections.Generic.IEnumerable<CodecInfo> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (CodecInfo element in c) {
      this.Add(element);
  ...
  private bool empty() {
    bool ret = pjsua2PINVOKE.CodecInfoVector_empty(swigCPtr);
    return ret;
  }
